...
EventType = Literal["rf", "adc", "grad x", "grad y", "grad z"]


class Sequence:
    def fov(self) -> tuple[float, float, float] | None: ...
    def duration(self) -> float: ...
    def encounter(self, t_start: float, ty: EventType) -> tuple[float, float] | None: ...
    def events(self, ty: EventType, t_start: float, t_end: float, max_count: int) -> list[float]: ...
    def next_event(self, ty: EventType, t_start: float) -> float | None: ...
